<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="投诉编号" prop="tousubianhao">
            <el-input v-model="ruleForm.tousubianhao" 
                placeholder="投诉编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tousubianhao" label="投诉编号" prop="tousubianhao">
              <el-input v-model="ruleForm.tousubianhao" 
                placeholder="投诉编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="投诉名称" prop="tousumingcheng">
          <el-input v-model="ruleForm.tousumingcheng" 
              placeholder="投诉名称" clearable  :readonly="ro.tousumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="投诉名称" prop="tousumingcheng">
              <el-input v-model="ruleForm.tousumingcheng" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.tousuneirong = this.ruleForm.tousuneirong.replace(reg,'../../../springboot003ds/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tousubianhao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tousubianhaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
