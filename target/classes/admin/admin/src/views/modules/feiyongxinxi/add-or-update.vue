<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="费用编号" prop="feiyongbianhao">
            <el-input v-model="ruleForm.feiyongbianhao" 
                placeholder="费用编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.feiyongbianhao" label="费用编号" prop="feiyongbianhao">
              <el-input v-model="ruleForm.feiyongbianhao" 
                placeholder="费用编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="费用名称" prop="feiyongmingcheng">
          <el-input v-model="ruleForm.feiyongmingcheng" 
              placeholder="费用名称" clearable  :readonly="ro.feiyongmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="费用名称" prop="feiyongmingcheng">
              <el-input v-model="ruleForm.feiyongmingcheng" 
                placeholder="费用名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
