          ...
          <el-form-item class="input" label="楼房位置" prop="loufangweizhi">
              <el-input v-model="ruleForm.loufangweizhi" 
                placeholder="楼房位置" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报修类型" prop="baoxiuleixing">
          <el-input v-model="ruleForm.baoxiuleixing" 
              placeholder="报修类型" clearable  :readonly="ro.baoxiuleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报修类型" prop="baoxiuleixing">
              <el-input v-model="ruleForm.baoxiuleixing" 
